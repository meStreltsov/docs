...
**VPN DATA** We DO NOT collect or store any VPN data. We DO NOT modify the contents of your VPN data. We DO NOT share any sensitive or user-specific data with third parties.
...
**DATA COLLECTION** Happ collects and transmits only crash reports and application diagnostics data. Crash data may include:
...
**ADVERTISING NETWORKS** Happ does not use monetization and has no plans for it in the future.

**CHILDREN’S PRIVACY** Happ does not collect any personally identifiable information from anyone, whether child or adult. This means no personally identifiable information is collected from children under 13.
