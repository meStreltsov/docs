...
When adding or updating a subscription, the application sends a request to the subscription server. If no response is received within 9 seconds, this error will be displayed.