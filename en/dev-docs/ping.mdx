...
Uses ICMP packets (similar to the `ping` command in a terminal). It is less convenient because it requires temporarily disabling the tunnel to perform the test.
