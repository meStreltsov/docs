...
[Provider ID](https://www.happ.su/main/dev-docs/provider-id) parameter is required!
...
<AccordionGroup>
  ...
  <Accordion title="Non-disableable HWID">
  ...
  <Accordion title="Subscription Expiration Notification">
  ...
  <Accordion title="Hide Server Settings in Subscription">
    <Frame>
      <img
  ...
  <Accordion title="Domain Resolving">
...
<AccordionGroup>
  ...
  <Accordion title="Auto-Update Subscriptions">
